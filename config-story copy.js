var config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      comment : 've, time consuming and difficult. <br> <br> Basic facility location data for WASH, Education and Health are sparse, incomplete and scattered in multiple <i>"data silos"</i>.<br>',
      location: {
